...
urlpatterns = [
    ...
    path('', views.customer_list, name='billing_index'),
...
path('sms/', views.sms_list, name='sms_list'),
    ...
    path('settings/subscription-types/', views.subscription_type_list, name='subscription_type_list'),
    ...
    path('settings/subscription-types/<int:pk>/delete/', views.subscription_type_delete, name='subscription_type_delete'),
    path('settings/subscription-types/<int:pk>/templates/', views.subscription_type_templates, name='subscription_type_templates'),
    ...
    path('reports/', views.billing_reports_view, name='billing_reports'),
    path('consumption-adjustments/', views.consumption_adjustment, name='consumption_adjustment'),
]